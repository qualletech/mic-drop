...
export default function Page({ params }: { params: { mic_id: string } }) {
  ...
  return (
    <main className="grid grid-rows-[auto_1fr] gap-3 max-h-full overflow-auto px-12 py-6">
      ...
      <blockquote
        ...
        data-instgrm-permalink="https://www.instagram.com/thetinycupboard/?utm_source=ig_embed&amp;utm_campaign=loading"
        data-instgrm-version="14"
      >
        <a href="https://www.instagram.com/thetinycupboard/?utm_source=ig_embed&amp;utm_campaign=loading" />
        ufhreiufhe
      </blockquote>
